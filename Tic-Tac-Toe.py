        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if 0<=row<10 and 0<=col<10:
                    if tic_tac_toe.board[row][col]==0:
                        tic_tac_toe.board[row][col]=tic_tac_toe.to_move
                        if tic_tac_toe.to_move==1:
                            tic_tac_toe.to_move=2
                        else:
                            tic_tac_toe.to_move=1
